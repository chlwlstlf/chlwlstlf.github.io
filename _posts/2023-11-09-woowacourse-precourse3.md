...
4\. constants > errorMessage, gameMessage

5\. models > RandomLotto(랜덤으로 생성된 로또), Lotto(당첨 로또 번호), Validate

6\. views > InputView(구입 금액, 당첨 번호, 보너스 번호 입력), OutputView(구매개수, 랜덤 로또 번호, 당첨 내역 출력)

7\. controller > Controller(게임 진행)
...
<div style="padding: 15px; border: 1px solid transparent; border-color: transparent; margin-bottom: 20px; border-radius: 4px; color: #31708f; background-color: #d9edf7; border-color: #bce8f1;">
  ...
  <p>→ 이 부분이 달라졌는데 문제를 제대로 읽고 넘어가지 않았었다.</p>
</div>
