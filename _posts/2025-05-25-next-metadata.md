...
## <mark class="pink">🔥1. 메타데이터 정보 상수화</mark>
...
## <mark class="pink">🔥2. 메타데이터 만드는 함수</mark>
...
## <mark class="pink">🔥3. 웹 사이트 title</mark>
...
## <mark class="pink">🔥4. 카카오톡 홈 페이지 링크 전송</mark>
...
## <mark class="pink">🔥5. 카카오톡 결과 페이지 링크 전송</mark>

**<mark class="yellow">[구현 사항]</mark>**

이 부분은 동적으로 메타데이터를 만들어야 하는 페이지다. 기획 내용에 맞게 변경했다. `generateMetadata`만 페이지 파일에 적어두면 동적으로 메타데이터가 생성된다.
...
현재 `og:url`에 아무 설정을 하지 않아 `https://concertseat.site` 메타 정보를 조회했고, 이 기본 메타데이터가 보였던 것이다.
...
## <mark class="pink">🔥6. 카카오톡 결과 공유하기</mark>
...
- 기본 메시지 템플릿(`objectType`): 메시지 구성 방법이 `sendDefault`일 때만 가능 ('feed' | 'list' | 'location' | 'commerce' | 'text')
...
## <mark class="pink">🔥5. 트위터 홈 페이지 링크 전송</mark>
...
## <mark class="pink">🔥6. 트위터 공유하기</mark>
...
## <mark class="pink">🔥7. 홈 화면 추가</mark>
...
## <mark class="pink">🔥8. 슬랙 & 디스코드</mark>
